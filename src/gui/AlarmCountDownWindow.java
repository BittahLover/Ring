...
public class AlarmCountDownWindow extends JFrame {
    ...
    public void initUI() {
        ...
        alarmTimePanel.setBackground(Color.pink);
        ...
        //The okay Button.
        JButton okayButton = new JButton("<html>" +
                "<font style = 'color:#000000;'>OK");
        okayButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                TimerWindow window = new TimerWindow(alarmName, seconds.getSeconds());
